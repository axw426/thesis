...
\begin{figure}
  \begin{subfigure}{.5\textwidth}
    ...
    \caption[Collinearity of $t\bar{t}$ pair]{Collinearity of the $t\bar{t}$ pair as a function of generator $\sqrt{s'}$.}
    \label{fig:Collinearity}
  \end{subfigure}
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{TopAnalysis/figures/CollinearityAlt.pdf}%
    \caption[Profiled $\sqrt{s'}$ distibution as a function of collinearity]{Profiled generator $\sqrt{s'}$ distibution as a function of collinearity.}
